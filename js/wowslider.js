  // -----------------------------------------------------------------------------------
                    ...
                    jQuery.fn.wowSlider = function(E) {
                        ...
                        var l = this;
                        var i = l.get(0);
                        E = M.extend({effect: function() {
                                this.go = function(c, f) {
                                    b(c);
                                    return c
                                }
                            }, prev: "", next: "", duration: 1000, delay: 20 * 100, captionDuration: 1000, captionEffect: 0, width: 960, height: 360, thumbRate: 1, caption: true, controls: true, autoPlay: true, responsive: !!document.addEventListener, stopOnHover: 0, preventCopy: 1}, E);
                        var a = M(".ws_images", l);
                        var R = a.find("ul");
                        function b(c) {
                            R.css({left: -c + "00%"})
                        }
                        M("<div>").css({width: "100%", visibility: "hidden", "font-size": 0, "line-height": 0}).append(a.find("li:first img:first").clone().css({width: "100%"})).prependTo(a);
                        R.css({position: "absolute", top: 0, animation: "none", "-moz-animation": "none", "-webkit-animation": "none"});
                        ...
                        if ((/MSIE/.test(z) && parseInt(/MSIE\s+([\d\.]+)/.exec(z)[1], 10) < 8) || (/Safari/.test(z))) {
                            ...
                            R.css({width: I + "00%", display: "table"});
                        ...
                        if (E.preventCopy && !/iPhone/.test(navigator.platform)) {
                            O = M('<div><a href="#" style="display:none;position:absolute;left:0;top:0;width:100%;height:100%"></a></div>').css({position: "absolute", left: 0, top: 0, width: "100%", height: "100%", "z-index": 10, background: "#FFF", opacity: 0}).appendTo(l).find("A").get(0)
                        }
                        var g = [];
                        j.each(function(c) {
                        ...
                        function Y(aq, au) {
                            ...
                            var ao = {};
                            ao[am] = (an ? "+=" : "-=") + c;
                            f.animate({opacity: 1}, {duration: au.duration, easing: au.easing});
                    ...
                    function ws_kenburns(q, k, d) {
                        ...
                        var p = q.paths || [{from: [0, 0, 1], to: [0, 0, 1.2]}, {from: [0, 0, 1.2], to: [0, 0, 1]}, {from: [1, 0, 1], to: [1, 0, 1.2]}, {from: [0, 1, 1.2], to: [0, 1, 1]}, {from: [1, 1, 1], to: [1, 1, 1.2]}, {from: [0.5, 1, 1], to: [0.5, 1, 1.3]}, {from: [1, 0.5, 1.2], to: [1, 0.5, 1]}, {from: [1, 0.5, 1], to: [1, 0.5, 1.2]}, {from: [0, 0.5, 1.2], to: [0, 0.5, 1]}, {from: [1, 0.5, 1.2], to: [1, 0.5, 1]}, {from: [0.5, 0.5, 1], to: [0.5, 0.5, 1.2]}, {from: [0.5, 0.5, 1.3], to: [0.5, 0.5, 1]}, {from: [0.5, 1, 1], to: [0.5, 0, 1.15]}];
                        function r(h) {
                        ...
                        var o, m;
                        function i() {
                            o = f('<div style="width:100%;height:100%"></div>').css({"z-index": 8, position: "absolute", left: 0, top: 0}).appendTo(d)
                        }
                        i();
                        function c(v, s, h) {
                            var t = {width: 100 * v[2] + "%"};
                        ...
                        function l(t, y, v) {
                            ...
                            if (b) {
                                ...
                                u.css({position: "absolute", left: 0, top: 0, width: "100%", height: "100%"}).appendTo(o);
                                ...
                                var w = f('<img src="' + t.src + '"/>').css({position: "absolute", left: "auto", right: "auto", top: "auto", bottom: "auto"}).appendTo(o).css(c(y.from, y.from[0] > 0.5, y.from[1] > 0.5)).animate(c(y.to, y.from[0] > 0.5, y.from[1] > 0.5), {easing: "linear", queue: false, duration: (1.5 * q.duration + q.delay)})
                            }
                            if (v) {
                                o.fadeIn(q.duration)
                            }
                    ...
                    (function(f, g, h, c) {
                        ...
                        f.fx.multipleValueStep = {_default: function(j) {
                    ...
                    ;
                    function ws_domino(d, b, a) {
                        $.extend($.easing, {easeInOutSine: function(m, l, i, j, k) {
                                return -j / 2 * (Math.cos(Math.PI * l / k) - 1) + i
                            }});
                        $.extend(d, {columns: d.columns | 5, rows: d.rows | 2, centerRow: d.centerRow | 2, centerColumn: d.centerColumn | 2});
                        var c = $("<div/>").css({position: "absolute", width: "100%", height: "100%", top: "0%", overflow: "hidden"});
                        c.hide().appendTo(a);
                        var e = a.find("ul");
                        this.go = function(r, q) {
                            function s() {
                                c.find("img").stop(1, 1);
                                c.hide();
                                c.empty()
                            ...
                            s();
                            if (d.fadeOut) {
                                e.fadeOut(d.duration)
                            }
                            var h = c.width();
                            var g = c.height();
                            var p = Math.floor(h / d.columns);
                            var n = Math.floor(g / d.rows);
                            var l = h - p * (d.columns - 1);
                            var v = g - n * (d.rows - 1);
                            function z(j, i) {
                                return Math.random() * (i - j + 1) + j
                            }
                            var m = [];
                            for (var u = 0; u < d.rows; u++) {
                                m[u] = [];
                                for (var t = 0; t < d.columns; t++) {
                                    var k = d.duration * (1 - Math.abs((d.centerRow * d.centerColumn - u * t) / (2 * d.rows * d.columns)));
                                    var w = t < d.columns - 1 ? p : l;
                                    var f = u < d.rows - 1 ? n : v;
                                    m[u][t] = $("<div/>").css({width: w, height: f, position: "absolute", top: u * n, left: t * p, overflow: "hidden"});
                                    var y = z(u - 2, u + 2);
                                    var x = z(t - 2, t + 2);
                                    m[u][t].appendTo(c);
                                    var A = $(b.get(r)).clone().css({position: "absolute", top: -y * n, left: -x * p, width: h, opacity: 0, height: g}).appendTo(m[u][t])
                                }
                            }
                            var o = 0;
                            c.show();
                            for (var u = 0; u < d.rows; u++) {
                                for (var t = 0; t < d.columns; t++) {
                                    m[u][t].find("img").animate({top: -u * n, left: -t * p, opacity: 1, deg: d.domino_rotation}, {duration: k, easing: "easeInOutSine", complete: function() {
                                            o++;
                                            if (o == d.rows * d.columns) {
                                                s();
                                                e.stop(1, 1);
                                                e.css("left", -r * 100 + "%").show()
                                            }
                                        }})
                                }
                            }
                    ...
                    ;
                    jQuery.extend(jQuery.easing, {easeOutOneBounce: function(e, b, c, a, i) {
                            var g = 0.8;
                            var f = 0.2;
                            var d = g * g;
                            if (e < 0.0001) {
                                ...
                                if (e < g) {
                                    ...
                                    return 1 - f * f + (e - g - f) * (e - g - f)
                                }
                            }
                        }});
                    jQuery.extend(jQuery.easing, {easeOutBounce: function(e, f, a, h, g) {
                            if ((f /= g) < (1 / 2.75)) {
                        ...
                        }, easeOutBack: function(c, e, a, g, d, f) {
                            if (f == undefined) {
                                f = 1.70158
                            }
                            return g * ((e = e / d - 1) * e * ((f + 1) * e + f) + 1) + a
                        }, easeOutBack2: function(c, e, a, g, d, f) {
                            if (c < f / 2) {
                                jQuery.easing.easeInCirc(c, e, a, g, d, f / 2)
                            } else {
                                return jQuery.easing.easeOutBounce(c - f / 2, e, a, g, d, f / 2)
                            }
                        }});
                    function ws_page(d, b, a) {
                        var f = d.angle || 17;
                        var c = jQuery("<div/>").css({position: "absolute", width: "100%", height: "100%", top: "0%", overflow: "hidden"});
                        var e = a.find("ul");
                        c.hide().appendTo(a);
                        this.go = function(l, j) {
                            ...
                            n();
                            e.hide();
                            var k = jQuery("<div/>").css({position: "absolute", left: 0, top: "-100%", width: "100%", height: "100%", overflow: "hidden", "z-index": 9}).append(jQuery(b.get(l)).clone().css({width: "100%", height: "100%"})).appendTo(c);
                            var i = jQuery("<div/>").css({position: "absolute", left: 0, top: 0, width: "100%", height: "100%", overflow: "visible", "z-index": 10, "transform-origin": "top left", "-webkit-backface-visibility": "hidden", "-moz-backface-visibility": "hidden", "-ms-backface-visibility": "hidden", "-o-backface-visibility": "hidden", "backface-visibility": "hidden"}).append(jQuery(b.get(j)).clone().css({width: "100%", height: "100%"})).appendTo(c);
                            c.show();
                            var p = i;
                            var o = p.width(), m = p.height();
                            var g = !!document.all;
                            if (g) {
                                i.css({left: "-50%", top: "-50%"});
                                p = i.find("img");
                                p.css({translateX: o / 2, translateY: m / 2})
                            }
                            p.animate({rotate: f, translateX: g ? Math.sqrt(o * o + m * m) * Math.sin(Math.PI * f / 180) / 2 + o / 4 : 0, translateY: g ? Math.sqrt(o * o + m * m) * Math.cos(Math.PI * f / 180) / 2 - m / 2 : 0}, {duration: 2 * d.duration / 3, easing: "easeOutOneBounce"}).animate(g ? {translateY: "+=" + m} : {top: "100%"}, {duration: d.duration / 3, easing: "linear", complete: function() {
                                    $(this).hide()
                                }});
                            k.animate({top: "-30%"}, {duration: d.duration / 2}).animate({top: "0%"}, {easing: "easeOutBounce", duration: d.duration / 2});
                            return l
                        }
                    }
                    ;// -----------------------------------------------------------------------------------
                    function ws_cube(k, g, a) {
                        ...
                        fullContCSS = {position: "absolute", backgroundSize: "cover", left: 0, top: 0, width: "100%", height: "100%", backfaceVisibility: "hidden"};
                        var j = {domPrefixes: " Webkit Moz ms O Khtml".split(" "), testDom: function(m) {
                                ...
                                if (m && /AppleWebKit/.test(navigator.userAgent)) {
                                    var o = document.createElement("div"), l = document.createElement("style"), n = "Test3d" + Math.round(Math.random() * 99999);
                        ...
                        this.go = function(s, p) {
                            ...
                            if (d) {
                                ...
                                var o = {left: [u / 2, u / 2, 0, 0, 90, 0, -90], right: [u / 2, -u / 2, 0, 0, -90, 0, 90], down: [q / 2, 0, -q / 2, 90, 0, -90, 0], up: [q / 2, 0, q / 2, -90, 0, 90, 0]}[k.direction || ["left", "right", "down", "up"][Math.floor(Math.random() * 4)]];
                                c("<div>").css(fullContCSS).appendTo(v).css({backgroundImage: "url(" + g.get(s).src + ")", transformOrigin: "50% 50% -" + o[0] + "px"});
                                c("<div>").css(fullContCSS).appendTo(v).css({backgroundImage: "url(" + g.get(p).src + ")", transformOrigin: "50% 50% -" + o[0] + "px"});
                                e.hide();
                                ...
                                var l = c("<div></div>").css({position: "absolute", display: "none", zIndex: 2, width: "100%", height: "100%"}).appendTo(a);
                                l.stop(1, 1);
                                var n = (!!((s - p + 1) % g.length) ^ k.revers ? "left" : "right");
                                var t = c(g[p]).clone().css({position: "absolute", left: "0%", right: "auto", top: 0, width: "100%", height: "100%", }).appendTo(l).css(n, 0);
                                var r = c(g[s]).clone().css({position: "absolute", left: "100%", right: "auto", top: 0, width: "0%", height: "100%", }).appendTo(l).show();
                    ...
                    function ws_book(n, l, b) {
                        ...
                        var k = n.no3d || false;
                        var m = {domPrefixes: " Webkit Moz ms O Khtml".split(" "), testDom: function(p) {
                                ...
                                if (p && /AppleWebKit/.test(navigator.userAgent)) {
                                    var r = document.createElement("div"), o = document.createElement("style"), q = "Test3d" + Math.round(Math.random() * 99999);
                        ...
                        this.go = function(p, o) {
                            ...
                            var C = (o == 0 && p != o + 1) || (p == o - 1), t = l.get(p), E = l.get(o);
                            var q = f("<div>").appendTo(b);
                            if (k) {
                                var w = {backgroundColor: "#000", position: "absolute", left: 0, top: 0, width: "100%", height: "100%", transformStyle: "preserve-3d", zIndex: 3, outline: "1px solid transparent"};
                                q.css(w);
                                perspect = b.width() * (3 - d * 2);
                                var x = 83.5;
                                var B = f("<div>").css(w).css({background: "url(" + (C ? t : E).src + ")", backgroundSize: "auto 100%", width: "50%", perspective: perspect}).appendTo(q);
                                var A = f("<div>").css(w).css({left: "50%", background: "url(" + (C ? E : t).src + ") right", backgroundSize: "auto 100%", width: "50%", perspective: perspect}).appendTo(q);
                                var G = f("<div>").css(w).css({background: "url(" + (C ? E : t).src + ")", backgroundSize: "auto 100%", transform: "rotateY(" + (C ? 0.1 : x) + "deg)", transition: (C ? "ease-in " : "ease-out ") + e / 2000 + "s", transformOrigin: "right", marginRight: "-100%", display: C ? "block" : "none"}).appendTo(B);
                                var D = f("<div>").css(w).css({background: "url(" + (C ? t : E).src + ") right", backgroundSize: "auto 100%", transform: "rotateY(-" + (C ? x : 0.1) + "deg)", transition: (C ? "ease-out " : "ease-in ") + e / 2000 + "s", transformOrigin: "left", marginRight: "-100%", display: C ? "none" : "block"}).appendTo(A);
                                var s = f("<div>").css(w).css({zIndex: 1, opacity: 1}).appendTo((C ? B : A)).clone().appendTo((C ? D : G)).css("opacity", g).clone().appendTo((C ? A : B)).css("opacity", 1).hide().clone().appendTo((C ? G : D)).css("opacity", g).hide()
                            } else {
                                if (a) {
                                    var v = f("<div>").css({position: "absolute", top: 0, left: C ? 0 : "50%", width: "50%", height: "100%", overflow: "hidden", zIndex: 6}).append(f(l.get(p)).clone().css({position: "absolute", height: "100%", right: C ? "auto" : 0, left: C ? 0 : "auto"})).appendTo(q).hide();
                                    var z = f("<div>").css({position: "absolute", width: "100%", height: "100%", left: 0, top: 0, zIndex: 8}).appendTo(q).hide();
                                    var F = f("<canvas>").css({position: "absolute", zIndex: 2, left: 0, top: -z.height() * d / 2}).attr({width: z.width(), height: z.height() * (d + 1)}).appendTo(z);
                                    var y = F.clone().css({top: 0, zIndex: 1}).attr({width: z.width(), height: z.height()}).appendTo(z);
                                    var u = F.get(0).getContext("2d");
                                    var r = y.get(0).getContext("2d")
                                } else {
                                    i.stop(true).animate({left: (p ? -p + "00%" : (/Safari/.test(navigator.userAgent) ? "0%" : 0))}, e, "easeInOutExpo")
                                }
                            }
                            if (!k && a) {
                                var B = u;
                        ...
                        function c(E, J, t, s, r, p, H, q, G, I) {
                            ...
                            for (var D = 0; D < numSlices + widthScale; D++) {
                                var B = 0, C = (H ? D * n.width / r + n.width / 2 : (numSlices - D) * n.width / r);
                                sWidth = sliceWidth * widthScale * 1.5, sHeight = n.height;
                                var z = t + (H ? 1 : -1) * sliceWidth * widthScale * D, u = s + F * heightScale * D / 2, o = sliceWidth * widthScale * 1.5, A = F * (1 - (heightScale * D));
                                if (C < 0) {
                                    C = 0
                                }
                                if (z < 0) {
                            ...
                            if (k) {
                                ...
                                if (a) {
                                    ...
                                    var o = setInterval(function() {
                                        ...
                                        var I = t.height() * d / 2, E = (1 - progressX) * t.width() / 2, D = 1 + progressY * d, J = t.width() / 2;
                        ...
                        jQuery.extend(jQuery.easing, {easeInOutCubic: function(p, q, o, s, r) {
                                if ((q /= r / 2) < 1) {
                                    return s / 2 * q * q * q + o
                                }
                    ...
                    function ws_seven(j, u, l) {
                        ...
                        var B = [];
                        var s = [];
                        l = l.parent().css({overflow: "visible"});
                        ...
                        l.append(d, v);
                        var f = {t: m(window).scrollTop(), l: m(window).scrollLeft(), w: m(window).width(), h: m(window).height()};
                        jQuery.extend(jQuery.easing, {easeOutQuart: function(C, D, e, F, E) {
                        ...
                        function z(F, E, G, e) {
                            var D = (E >= e) ? (e) / (E) : 1;
                            var C = (F >= G) ? (G) / (F) : 1;
                            return{l: C, t: D, m: Math.min(C, D)}
                        }
                        function r(L, C, K, M) {
                            var G = d.width(), I = d.height(), J = k * G / c, F = k * I / t, e = a;
                            var D = f.h + f.t - I / t, H = f.w + f.l - G / c, N = d.offset().top + d.height(), E = d.offset().left + d.width();
                            if (D < N) {
                                D = N
                            }
                            if (H < E) {
                            ...
                            if (K) {
                                m(L).each(function(R) {
                                    ...
                                    var P = z(U, T, H, D);
                                    m(this).css({opacity: 1, left: G * S / c, top: I * Q / t, width: G / c, height: I / t, zIndex: Math.ceil(100 - p(S, c) * 100)}).delay(O).animate({opacity: 0, left: (J * S - G * k / 2) * P.l, top: (F * Q - I * k / 2) * P.t, width: J * P.m, height: F * P.m}, {duration: a * 4 / (c * t), easing: "easeInExpo", complete: function() {
                                            m(this).hide()
                                        }});
                                    m(this).find("img").css({left: -(G * S / c), top: -(I * Q / t), width: G, height: I}).delay(O).animate({left: -J * S * P.m, top: -F * Q * P.m, width: k * G * P.m, height: k * I * P.m}, a * 4 / (c * t), "easeInExpo")
                                });
                                m(C).each(function(Q) {
                                    var R = Q % c;
                                    var P = Math.floor(Q / c);
                                    var O = a * 0.2 + a * 0.15 * (p(R, c) * 35 + P * 4) / (c * t);
                                    m(this).css({left: G / 2, top: I / 2, width: 0, height: 0, zIndex: Math.ceil(100 - p(R, c) * 100)}).delay(O).animate({left: G * R / c, top: I * P / t, width: G / c + 1, height: I / t + 1}, a * 4 / (c * t), "easeOutBack");
                                    m(this).find("img").css({left: 0, top: 0, width: 0, height: 0}).delay(O).animate({left: -(G * R / c), top: -(I * P / t), width: G, height: I}, a * 4 / (c * t), "easeOutBack")
                                });
                                v.delay(a * 0.1).animate({opacity: 1}, a * 0.2, "easeInCirc");
                                e *= 0.6
                            } else {
                                m(L).each(function(R) {
                                    var S = R % c;
                                    ...
                                    var T = d.offset().top + f.t + F * Q - d.height() * k / 2 + F;
                                    var P = z(U, T, H, D);
                                    m(this).css({opacity: 0, left: (J * S - d.width() * k / 2) * P.l, top: (F * Q - d.height() * k / 2) * P.t, width: J * P.m, height: F * P.m, zIndex: Math.ceil(100 - p(S, c) * 100)}).delay(O).animate({opacity: 1, left: G * S / c, top: I * Q / t, width: G / c + 1, height: I / t + 1}, {duration: a * 5 / (c * t), easing: "easeOutQuart"});
                                    m(this).find("img").css({left: -J * S * P.m, top: -F * Q * P.m, width: k * G * P.m, height: k * I * P.m}).delay(O).animate({left: -(G * S / c), top: -(I * Q / t), width: G, height: I}, a * 5 / (c * t), "easeOutQuart")
                                });
                                e *= 0.43
                            }
                            setTimeout(M, e);
                        ...
                        this.go = function(I, D) {
                            ...
                            if (H) {
                                ...
                                if (q) {
                                    ...
                                    if (!i) {
                                        ...
                                        i = m(i + i).css({"z-index": 1, position: "absolute", width: "100%", height: "100%", left: 0, top: 0}).appendTo(l)
                                    } else {
                                        i.show()
                                    }
                            ...
                            d.css({position: "absolute", width: l.width(), height: l.height(), left: 0, top: 0, zIndex: 8, overflow: "visible"});
                            v.css({opacity: 1, position: "absolute", top: 0, left: 0, width: l.width(), height: l.height(), zIndex: 2});
                            for (var G = 0; G < c * t; G++) {
                                var F = G % c;
                                var E = Math.floor(G / c);
                                m(B[G] = document.createElement("div")).css({position: "absolute", overflow: "hidden"}).appendTo(d).append(m("<img>").css({position: "absolute"}));
                                if (H) {
                                    m(s[G] = document.createElement("div")).css({position: "absolute", overflow: "hidden"}).appendTo(v).append(m("<img>").css({position: "absolute"}))
                                }
                            }
                            B = m(B);
                            if (H) {
                            ...
                            d.css({opacity: 1, zIndex: 3}).find("img").attr("src", u.get(H ? D : I).src);
                            if (H) {
                                v.css({opacity: 0}).find("img").attr("src", u.get(I).src)
                            } else {
                                v.append(m("<img>").css({position: "absolute", width: "100%", height: "100%"}).attr("src", u.get(D).src))
                            }
                            h = new r(B, s, H, function() {
                                x.css({left: -I + "00%"}).stop(true, true).show();
